...
odyssey_youtube_plot = plot_histograms("Odyssey", "youtube")
odyssey_meta_plot = plot_histograms("Odyssey", "meta")
odyssey_shopify_plot = plot_histograms("Odyssey", "shopify")
odyssey_ppc_plot = plot_histograms("Odyssey", "ppc")
